...
/**
 * Enemy that follows a pattern that looks like an eight
 */
public class EightEnemy extends TrigEnemy {

    public EightEnemy(int cX, int cY, int w, int h, Color c, 
            double s, double st) {
    ...
    public Enemy clone() {
        ...
        return new EightEnemy(getCenterX(), getCenterY(), 
